...
updated: 2026-01-21T03:16:40.356Z
...
[![NPM Downloads](https://camo.githubusercontent.com/5709935e9be3074d8fee040efdbb587fc8a77027aa9cbacc0ea676aa300454d4/68747470733a2f2f696d672e736869656c64732e696f2f6e706d2f64772f253430676f6f676c6525324667656e6169)](https://www.npmjs.com/package/@google/genai) [![Node Current](https://camo.githubusercontent.com/dc409db4c369c1c29bd4ee3fed64408be212652520710541e51ae6b3c8a998ce/68747470733a2f2f696d672e736869656c64732e696f2f6e6f64652f762f253430676f6f676c6525324667656e6169)](https://www.npmjs.com/package/@google/genai)
...
const ai \= new GoogleGenAI({apiKey: GEMINI\_API\_KEY});
...
const ai \= new GoogleGenAI({
    vertexai: true,
    project: 'your\_project',
    location: 'your\_location',
});
...
// 2. Second turn (passing previous\_interaction\_id)
...
const interaction \= await ai.interactions.create({
  ...
  input: \[
    ...
    { type: 'image', data: base64Image, mime\_type: 'image/png' },
  \],
});
...
for (const output of interaction.outputs!) {
  if (output.type \=== 'image') {
    console.log(\`Generated image with mime\_type: ${output.mime\_type}\`);
    // Save the image
    fs.writeFileSync(
        'generated\_city.png', Buffer.from(output.data!, 'base64'));
  }
}
